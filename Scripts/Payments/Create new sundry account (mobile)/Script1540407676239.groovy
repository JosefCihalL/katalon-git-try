...
WebUI.click(findTestObject('Home page/Button_Home (mobile)'))

WebUI.click(findTestObject('Home page/Dropdown_Payments (mobile)'))

WebUI.click(findTestObject('Payments/Guidepost_Sundry accounts'))

WebUI.click(findTestObject('Payments/Sundry accounts/Button_Create new account (mobile)'))
...
WebUI.waitForElementVisible(findTestObject('Payments/Sundry accounts/Create new account/Input_Account name'), 3)
