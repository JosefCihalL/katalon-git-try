...
WebUI.callTestCase(findTestCase('Payments/Create new sundry account'), [('AccountName') : GlobalVariable.AccountName], FailureHandling.STOP_ON_FAILURE)
...
for (def index : (0..5)) {
    ...
    if (CountryStep1 == 'Czech Republic') {
        ...
        WebUI.verifyElementNotPresent(findTestObject('Payments/Sundry accounts/External payment/STEP 2/Label_Post code'), 
            0)

        WebUI.verifyElementNotPresent(findTestObject('Payments/Sundry accounts/External payment/STEP 2/Input_Post code'), 
            0)
        ...
        WebUI.verifyElementNotPresent(findTestObject('Payments/Sundry accounts/External payment/STEP 2/Label_Country'), 
            0)

        WebUI.verifyElementNotPresent(findTestObject('Payments/Sundry accounts/External payment/STEP 2/Select_Country'), 
            0)
        ...
        WebUI.selectOptionByLabel(findTestObject('Payments/Sundry accounts/External payment/STEP 2/Select_countryElse'), 
            CountryStep2, false)
